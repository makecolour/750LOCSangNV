...
public class GetInput {
     ...
     * entered by the user.
     */
    public static LocalDate getManufactureDate(String msg) {
        do {
            try {
     ...
     * user.
     */
    public static LocalDate getExpiryAndReceiptDate(String msg) {
        String date;
        do {
            try {
                date = getString(msg);
    ...
    public static String getStorekeeperName(String name, ArrayList<Storekeeper> list) {
        do {
            int flag = 0;
            name = getString("storekeeper name");
            for (Storekeeper s : list) {
                if (name.equalsIgnoreCase(s.getName())) {
